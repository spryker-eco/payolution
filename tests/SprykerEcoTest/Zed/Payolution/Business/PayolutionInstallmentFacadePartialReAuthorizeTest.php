 ...
 * @group Business
 * @group Facade
 * @group PayolutionInstallmentFacadePartialReAuthorizeTest
 * Add your own group annotations below this line
 */
class PayolutionInstallmentFacadePartialReAuthorizeTest extends PayolutionFacadePartialReAuthorizeTest
{
    /**
     * @return void
     */
